...
from misc_utils.label_dict import LABEl_NAME_MAP
NOT_DRAW_BOXES = 0
ONLY_DRAW_BOXES = -1
...
def draw_boxes_with_label_and_scores(img_array, boxes, labels, scores):
    img_array = img_array + np.array(cfgs.MEAN_COLOR)
...
if __name__ == '__main__':
    ...
    img_array = np.array(img_array, np.float32) - np.array(cfgs.MEAN_COLOR)
    boxes = np.array(
        [[200, 200, 500, 500],
         [300, 300, 400, 400],
         [200, 200, 400, 400]]
